---
title: Lint Rules
description: Complete reference of all 40 RunContext lint rules across Bronze, Silver, Gold, Data, and Composite tiers.
---

import { Aside } from '@astrojs/starlight/components';

RunContext includes 40 lint rules organized by tier. Rules are checked with `context lint` (or `npx @runcontext/cli lint`) and auto-fixable rules can be applied with `context fix` (or `npx @runcontext/cli fix`).
