...
description: Connect ContextKit to any data warehouse — PostgreSQL, DuckDB, Snowflake, BigQuery, MySQL, and more.
---
...
<Aside type="caution">
Never commit credentials to version control. Use `${ENV_VAR}` syntax in your config — ContextKit expands environment variables at runtime.
</Aside>
