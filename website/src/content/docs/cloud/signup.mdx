...
description: "Create a ContextKit Cloud account, set up your organization, publish your first semantic plane, and connect your team's AI tools."
---
...
2. **Publish**
   ...
   This compiles your local semantic plane and uploads it to ContextKit Cloud. The output shows:
...
## Set Up Guardrailed MCP Connectors

Instead of using generic MCP database tools (which may expose write access), connect your databases through ContextKit's guardrailed connectors. They introspect your schema and serve context to AI agents — strictly read-only, no mutations, no raw data extraction.
