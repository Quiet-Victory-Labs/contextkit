...
Instead of using generic MCP database tools (which may expose write access), connect your databases through RunContext's guardrailed connectors. They introspect your schema and serve context to AI agents — strictly read-only, no mutations, no raw data extraction.
...
2. **Choose your database**
   ...
   <Aside type="tip">
   For security, connections use SSL/TLS and credentials are encrypted at rest. We recommend creating a read-only database user specifically for RunContext.
   </Aside>
