---
title: Installation
description: "Install ContextKit CLI for metadata governance and AI-ready semantic layers. Supports DuckDB, PostgreSQL, MySQL, Snowflake, BigQuery, and 4 more databases."
---
