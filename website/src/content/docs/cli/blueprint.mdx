...
description: Export AI Blueprints — portable, Gold-tier semantic plane specifications in OSI YAML.
---

The `blueprint` command exports your semantic planes as **AI Blueprints** — self-contained YAML files that capture the complete semantic specification following the Open Semantic Interchange (OSI) v1.0 standard.

An AI Blueprint is the Gold-tier deliverable. It contains every dataset, field, relationship, metric, business rule, guardrail filter, golden query, and glossary term for a semantic plane in a single portable file.
...
### Export a single semantic plane
...
- **Share them** — hand a blueprint to any team or tool that needs to understand your semantic plane
...
- Create more semantic planes: [`context new`](/cli/new/)
