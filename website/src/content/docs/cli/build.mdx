...
The `build` command compiles all context files (`.osi.yaml`, `.governance.yaml`, etc.) into a single `runcontext-manifest.json` that MCP servers and other tools consume.
