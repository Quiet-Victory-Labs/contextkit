...
Agent: context blueprint → exports AI Blueprint (portable Gold-tier spec)
...
- **16 CLI commands** — introspect, enrich, lint, fix, build, tier, blueprint, new, verify, serve, and more
- **Data products** — scaffold multiple data products in one project with `context new <name>`
- **AI Blueprints** — export the Gold-tier outcome as a portable OSI YAML file with `context blueprint`
