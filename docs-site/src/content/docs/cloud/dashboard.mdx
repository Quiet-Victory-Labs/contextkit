...
<Aside type="note">
Connectors run introspection only — they read your schema metadata but never query your actual data rows. The connection uses read-only access over encrypted channels.
</Aside>
