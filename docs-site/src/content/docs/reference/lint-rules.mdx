---
title: Lint Rules
description: Complete reference of all 37 ContextKit lint rules across Bronze, Silver, Gold, and Data tiers.
---

import { Aside } from '@astrojs/starlight/components';

ContextKit includes 37 lint rules organized by tier. Rules are checked with `npx contextkit lint` and auto-fixable rules can be applied with `npx contextkit fix`.
