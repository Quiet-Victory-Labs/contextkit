...
<Aside type="note">
Tier scorecards reflect the results of `contextkit build`. If you have made changes to your context files since the last build, re-run `npx contextkit build` to get up-to-date results.
</Aside>
