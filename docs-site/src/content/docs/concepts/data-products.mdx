---
title: Data Products & AI Blueprints
...
The **AI Blueprint** is the Gold-tier deliverable — a single, portable YAML file that captures the complete semantic specification for a data product. Export it with [`context blueprint`](/cli/blueprint/), serve it via MCP at `context://data-product/{name}`, or share it with any OSI-compliant tool.
